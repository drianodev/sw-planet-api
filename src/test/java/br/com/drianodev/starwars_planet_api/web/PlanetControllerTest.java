...
import static br.com.drianodev.starwars_planet_api.common.PlanetConstants.TATOOINE;
...
public class PlanetControllerTest {
    ...
    public void listPlanets_ReturnsFilteredPlanets() throws Exception {
        when(planetService.listPlanets(null, null)).thenReturn(PLANETS);
        when(planetService.listPlanets(TATOOINE.getClimate(), TATOOINE.getTerrain())).thenReturn(List.of(TATOOINE));
